...
<?php endif; ?>
    ...
    <!-- __BLOCK__ --><?php if($datalistOptions): ?>
        <datalist id="<?php echo e($id); ?>-list">
            <!-- __BLOCK__ --><?php $__currentLoopData = $datalistOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\filament\vendor\filament\forms\src\/../resources/views/components/text-input.blade.php ENDPATH**/ ?>