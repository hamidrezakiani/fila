...
<?php endif; ?>
    ...
    <!-- __BLOCK__ --><?php if(filled($heading)): ?>
        <h1
    ...
    <!-- __BLOCK__ --><?php if(filled($subheading)): ?>
        <p
...
<?php /**PATH C:\xampp\htdocs\filament\vendor\filament\filament\src\/../resources/views/components/header/simple.blade.php ENDPATH**/ ?>