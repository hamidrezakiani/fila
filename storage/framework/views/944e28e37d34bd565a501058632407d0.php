...
<div <?php echo e($attributes->class(['fi-fo-field-wrp'])); ?>>
    <!-- __BLOCK__ --><?php if($label && $labelSrOnly): ?>
    ...
    >
        <!-- __BLOCK__ --><?php if(($label && (! $labelSrOnly)) || $labelPrefix || $labelSuffix || filled($hint) || $hintIcon || count($hintActions)): ?>
            <div
                class="<?php echo \Illuminate\Support\Arr::toCssClasses([
...
<?php endif; ?>
                ...
                <!-- __BLOCK__ --><?php if(filled($hint) || $hintIcon || count($hintActions)): ?>
                    <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
...
<?php endif; ?>
        ...
        <!-- __BLOCK__ --><?php if((! \Filament\Support\is_slot_empty($slot)) || $hasError || filled($helperText)): ?>
            <div
                class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                    'grid gap-y-2',
...
<?php endif; ?>
                ...
                <!-- __BLOCK__ --><?php if(filled($helperText)): ?>
                    <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
...
<?php /**PATH C:\xampp\htdocs\filament\vendor\filament\forms\src\/../resources/views/components/field-wrapper/index.blade.php ENDPATH**/ ?>